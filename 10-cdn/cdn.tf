...
resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              = "web-${var.environment}.${var.zone_name}"#web-dev.avinexpense.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.avinexpense.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-${var.common_tags.Component}" # web-cdn.avinexpense.online
      type    = "A"
