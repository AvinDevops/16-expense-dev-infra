### creating frontend ec2 instance or server ###
module "frontend" {
...
## configuring frontend server with null resource with remote exec ##
resource "null_resource" "frontend" {
    # whenevr frontend server is created, null resource will be trigered
    triggers = {
...
## taking frontend ami nd creating ami
...
resource "aws_autoscaling_group" "frontend" {
  ...
  vpc_zone_identifier   = split("," ,data.aws_ssm_parameter.frontend_subnet_ids.value)
